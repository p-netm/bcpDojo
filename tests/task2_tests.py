...
class Task2tests(unittest.TestCase):
    ...
    def test_if_file_exists_function(self):
        dojo = Dojo()
        self.assertEqual(os.path.isfile("asdhjdaw.txt"), False,
    ...
    #
    #     dojo = Dojo()
    #     file_handler = open("files\read_file_function_golden_file.txt", 'r')
...
class testsForReallocatePerson(unittest.TestCase):
    ...
    def test_read_file_names_function(self):
        dojo = Dojo()
        file_name = dojo.return_file_dir("load_people.txt", 'input')
